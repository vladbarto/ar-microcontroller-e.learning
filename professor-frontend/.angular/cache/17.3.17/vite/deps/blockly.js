  ...
  "node_modules/blockly/blocks_compressed.js"(exports, module) {
    (function(root, factory) {
      ...
      var blocks$$module$build$src$blocks$colour = $.createBlockDefinitionsFromJsonArray$$module$build$src$core$common([{ type: "colour_picker", message0: "%1", args0: [{ type: "field_colour", name: "COLOUR", colour: "#ff0000" }], output: "Colour", helpUrl: "%{BKY_COLOUR_PICKER_HELPURL}", style: "colour_blocks", tooltip: "%{BKY_COLOUR_PICKER_TOOLTIP}", extensions: ["parent_tooltip_when_inline"] }, {
        ...
        args0: [{ type: "input_value", name: "COLOUR1", check: "Colour", align: "RIGHT" }, { type: "input_value", name: "COLOUR2", check: "Colour", align: "RIGHT" }, { type: "input_value", name: "RATIO", check: "Number", align: "RIGHT" }],
        output: "Colour",
      ...
      module$exports$Blockly$libraryBlocks$lists.blocks = module$contents$Blockly$libraryBlocks$lists_createBlockDefinitionsFromJsonArray([{ type: "lists_create_empty", message0: "%{BKY_LISTS_CREATE_EMPTY_TITLE}", output: "Array", style: "list_blocks", tooltip: "%{BKY_LISTS_CREATE_EMPTY_TOOLTIP}", helpUrl: "%{BKY_LISTS_CREATE_EMPTY_HELPURL}" }, {
        type: "lists_repeat",
      ...
      module$exports$Blockly$libraryBlocks$lists.blocks.lists_create_with = { init: function() {
      ...
      module$exports$Blockly$libraryBlocks$lists.blocks.lists_create_with_container = { init: function() {
        this.setStyle("list_blocks");
      ...
      module$exports$Blockly$libraryBlocks$lists.blocks.lists_create_with_item = { init: function() {
        this.setStyle("list_blocks");
      ...
      module$exports$Blockly$libraryBlocks$lists.blocks.lists_indexOf = { init: function() {
        ...
        a = $.module$build$src$core$field_registry.fromJson({ type: "field_dropdown", options: a });
      ...
      module$exports$Blockly$libraryBlocks$lists.blocks.lists_getIndex = { init: function() {
        ...
        this.WHERE_OPTIONS = [[module$contents$Blockly$libraryBlocks$lists_Msg.LISTS_GET_INDEX_FROM_START, "FROM_START"], [
          module$contents$Blockly$libraryBlocks$lists_Msg.LISTS_GET_INDEX_FROM_END,
          "FROM_END"
        ], [module$contents$Blockly$libraryBlocks$lists_Msg.LISTS_GET_INDEX_FIRST, "FIRST"], [module$contents$Blockly$libraryBlocks$lists_Msg.LISTS_GET_INDEX_LAST, "LAST"], [module$contents$Blockly$libraryBlocks$lists_Msg.LISTS_GET_INDEX_RANDOM, "RANDOM"]];
        ...
        const b = this;
        this.setTooltip(function() {
          const c = b.getFieldValue("MODE"), d = b.getFieldValue("WHERE");
          let e = "";
          switch (c + " " + d) {
            case "GET FROM_START":
            case "GET FROM_END":
        ...
        a.isStatement ? this.updateStatement_(true) : "string" === typeof a && this.domToMutation($.module$build$src$core$utils$xml.textToDom(a));
      ...
      module$exports$Blockly$libraryBlocks$lists.blocks.lists_setIndex = { init: function() {
        ...
        this.WHERE_OPTIONS = [[module$contents$Blockly$libraryBlocks$lists_Msg.LISTS_GET_INDEX_FROM_START, "FROM_START"], [module$contents$Blockly$libraryBlocks$lists_Msg.LISTS_GET_INDEX_FROM_END, "FROM_END"], [
          module$contents$Blockly$libraryBlocks$lists_Msg.LISTS_GET_INDEX_FIRST,
          "FIRST"
        ], [module$contents$Blockly$libraryBlocks$lists_Msg.LISTS_GET_INDEX_LAST, "LAST"], [module$contents$Blockly$libraryBlocks$lists_Msg.LISTS_GET_INDEX_RANDOM, "RANDOM"]];
        ...
        this.setTooltip(function() {
          ...
          if ("FROM_START" === d || "FROM_END" === d) e += "  " + module$contents$Blockly$libraryBlocks$lists_Msg.LISTS_INDEX_FROM_START_TOOLTIP.replace(
            "%1",
        ...
        const a = $.module$build$src$core$utils$xml.createElement("mutation"), b = this.getInput("AT").type === $.module$build$src$core$connection_type.ConnectionType.INPUT_VALUE;
        a.setAttribute("at", b);
        return a;
      }, domToMutation: function(a) {
        a = "false" !== a.getAttribute("at");
        ...
        this.removeInput("ORDINAL", true);
        a ? (this.appendValueInput("AT").setCheck("Number"), module$contents$Blockly$libraryBlocks$lists_Msg.ORDINAL_NUMBER_SUFFIX && this.appendDummyInput("ORDINAL").appendField(module$contents$Blockly$libraryBlocks$lists_Msg.ORDINAL_NUMBER_SUFFIX)) : this.appendDummyInput("AT");
        const b = $.module$build$src$core$field_registry.fromJson({ type: "field_dropdown", options: this.WHERE_OPTIONS });
        b.setValidator(function(c) {
          const d = "FROM_START" === c || "FROM_END" === c;
          if (d !== a) {
            const e = this.getSourceBlock();
      ...
      module$exports$Blockly$libraryBlocks$lists.blocks.lists_getSublist = { init: function() {
        ...
        this.WHERE_OPTIONS_2 = [
          [module$contents$Blockly$libraryBlocks$lists_Msg.LISTS_GET_SUBLIST_END_FROM_START, "FROM_START"],
          [module$contents$Blockly$libraryBlocks$lists_Msg.LISTS_GET_SUBLIST_END_FROM_END, "FROM_END"],
          [module$contents$Blockly$libraryBlocks$lists_Msg.LISTS_GET_SUBLIST_END_LAST, "LAST"]
        ];
        ...
        const c = $.module$build$src$core$field_registry.fromJson({ type: "field_dropdown", options: this["WHERE_OPTIONS_" + a] });
      ...
      module$exports$Blockly$libraryBlocks$lists.blocks.lists_sort = { init: function() {
        this.jsonInit({
      ...
      module$exports$Blockly$libraryBlocks$lists.blocks.lists_split = { init: function() {
        const a = this, b = $.module$build$src$core$field_registry.fromJson({ type: "field_dropdown", options: [[module$contents$Blockly$libraryBlocks$lists_Msg.LISTS_SPLIT_LIST_FROM_TEXT, "SPLIT"], [module$contents$Blockly$libraryBlocks$lists_Msg.LISTS_SPLIT_TEXT_FROM_LIST, "JOIN"]] });
        b.setValidator(function(c) {
          a.updateType_(c);
        });
      ...
      module$exports$Blockly$libraryBlocks$logic.blocks = module$contents$Blockly$libraryBlocks$logic_createBlockDefinitionsFromJsonArray([
        ...
        { type: "controls_if", message0: "%{BKY_CONTROLS_IF_MSG_IF} %1", args0: [{
          type: "input_value",
          name: "IF0",
          check: "Boolean"
        }], message1: "%{BKY_CONTROLS_IF_MSG_THEN} %1", args1: [{ type: "input_statement", name: "DO0" }], previousStatement: null, nextStatement: null, style: "logic_blocks", helpUrl: "%{BKY_CONTROLS_IF_HELPURL}", suppressPrefixSuffix: true, mutator: "controls_if_mutator", extensions: ["controls_if_tooltip"] },
        {
        ...
        { type: "logic_compare", message0: "%1 %2 %3", args0: [{ type: "input_value", name: "A" }, { type: "field_dropdown", name: "OP", options: [["=", "EQ"], ["≠", "NEQ"], ["‏<", "LT"], ["‏≤", "LTE"], ["‏>", "GT"], [
          "‏≥",
          "GTE"
        ]] }, { type: "input_value", name: "B" }], inputsInline: true, output: "Boolean", style: "logic_blocks", helpUrl: "%{BKY_LOGIC_COMPARE_HELPURL}", extensions: ["logic_compare", "logic_op_tooltip"] },
        {
          type: "logic_operation",
          message0: "%1 %2 %3",
          args0: [{ type: "input_value", name: "A", check: "Boolean" }, { type: "field_dropdown", name: "OP", options: [["%{BKY_LOGIC_OPERATION_AND}", "AND"], ["%{BKY_LOGIC_OPERATION_OR}", "OR"]] }, { type: "input_value", name: "B", check: "Boolean" }],
          inputsInline: true,
          output: "Boolean",
          style: "logic_blocks",
        ...
        { type: "logic_ternary", message0: "%{BKY_LOGIC_TERNARY_CONDITION} %1", args0: [{
          type: "input_value",
          name: "IF",
          check: "Boolean"
        ...
        { type: "controls_if_elseif", message0: "%{BKY_CONTROLS_IF_ELSEIF_TITLE_ELSEIF}", previousStatement: null, nextStatement: null, enableContextMenu: false, style: "logic_blocks", tooltip: "%{BKY_CONTROLS_IF_ELSEIF_TOOLTIP}" },
      ...
      var module$contents$Blockly$libraryBlocks$logic_LOGIC_TERNARY_ONCHANGE_MIXIN = { prevParentConnection_: null, onchange: function(a) {
        ...
        if ((b || c) && d) for (let e = 0; 2 > e; e++) {
          const f = 1 === e ? b : c;
          f && !f.workspace.connectionChecker.doTypeChecks(f.outputConnection, d) && ($.module$build$src$core$events$events.setGroup(a.group), d === this.prevParentConnection_ ? (this.unplug(), d.getSourceBlock().bumpNeighbours()) : (f.unplug(), f.bumpNeighbours()), $.module$build$src$core$events$events.setGroup(false));
        }
      ...
      module$exports$Blockly$libraryBlocks$loops.blocks = module$contents$Blockly$libraryBlocks$loops_createBlockDefinitionsFromJsonArray([{ type: "controls_repeat_ext", message0: "%{BKY_CONTROLS_REPEAT_TITLE}", args0: [{ type: "input_value", name: "TIMES", check: "Number" }], message1: "%{BKY_CONTROLS_REPEAT_INPUT_DO} %1", args1: [{ type: "input_statement", name: "DO" }], previousStatement: null, nextStatement: null, style: "loop_blocks", tooltip: "%{BKY_CONTROLS_REPEAT_TOOLTIP}", helpUrl: "%{BKY_CONTROLS_REPEAT_HELPURL}" }, {
      ...
      }, { type: "controls_whileUntil", message0: "%1 %2", args0: [{ type: "field_dropdown", name: "MODE", options: [["%{BKY_CONTROLS_WHILEUNTIL_OPERATOR_WHILE}", "WHILE"], [
        ...
        "CONTINUE"
      ]] }], previousStatement: null, style: "loop_blocks", helpUrl: "%{BKY_CONTROLS_FLOW_STATEMENTS_HELPURL}", suppressPrefixSuffix: true, extensions: ["controls_flow_tooltip", "controls_flow_in_loop_check"] }]);
      var module$contents$Blockly$libraryBlocks$loops_WHILE_UNTIL_TOOLTIPS = { WHILE: "%{BKY_CONTROLS_WHILEUNTIL_TOOLTIP_WHILE}", UNTIL: "%{BKY_CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL}" };
      ...
      var module$contents$Blockly$libraryBlocks$loops_BREAK_CONTINUE_TOOLTIPS = { BREAK: "%{BKY_CONTROLS_FLOW_STATEMENTS_TOOLTIP_BREAK}", CONTINUE: "%{BKY_CONTROLS_FLOW_STATEMENTS_TOOLTIP_CONTINUE}" };
      ...
      var module$contents$Blockly$libraryBlocks$loops_CUSTOM_CONTEXT_MENU_CREATE_VARIABLES_GET_MIXIN = { customContextMenu: function(a) {
        if (!this.isInFlyout) {
      ...
      module$exports$Blockly$libraryBlocks$loops.loopTypes = /* @__PURE__ */ new Set(["controls_repeat", "controls_repeat_ext", "controls_forEach", "controls_for", "controls_whileUntil"]);
      var module$contents$Blockly$libraryBlocks$loops_CONTROL_FLOW_IN_LOOP_CHECK_MIXIN = { getSurroundLoop: function() {
        let a = this;
        do {
      ...
      var module$contents$Blockly$libraryBlocks$procedures_PROCEDURE_DEF_COMMON = { setStatements_: function(a) {
        ...
        for (let c = 0; c < this.argumentVarModels_.length; c++) {
          const d = $.module$build$src$core$utils$xml.createElement("arg"), e = this.argumentVarModels_[c];
        ...
        if (null !== a && (a = "TRUE" === a, this.hasStatements_ !== a)) if (a) this.setStatements_(true), $.Mutator$$module$build$src$core$mutator.reconnect(
        ...
        if (this.mutator && this.mutator.isVisible()) {
          const c = this.mutator.workspace_.getAllBlocks(false);
        ...
        if (!this.isInFlyout) {
          var b = { enabled: true }, c = this.getFieldValue("NAME");
          ...
          a.push(b);
          if (!this.isCollapsed()) for (b = 0; b < this.argumentVarModels_.length; b++) d = { enabled: true }, c = this.argumentVarModels_[b], d.text = module$contents$Blockly$libraryBlocks$procedures_Msg.VARIABLES_SET_CREATE_GET.replace(
            "%1",
            c.name
          ), c = $.module$build$src$core$variables.generateVariableFieldDom(c), e = $.module$build$src$core$utils$xml.createElement("block"), e.setAttribute("type", "variables_get"), e.appendChild(c), d.callback = $.module$build$src$core$contextmenu.callbackFactory(this, e), a.push(d);
        }
      } };
      module$exports$Blockly$libraryBlocks$procedures.blocks.procedures_defnoreturn = Object.assign({}, module$contents$Blockly$libraryBlocks$procedures_PROCEDURE_DEF_COMMON, { init: function() {
        var a = $.module$build$src$core$procedures.findLegalName("", this);
        a = $.module$build$src$core$field_registry.fromJson({ type: "field_input", text: a });
        a.setValidator($.module$build$src$core$procedures.rename);
        a.setSpellcheck(false);
        this.appendDummyInput().appendField(module$contents$Blockly$libraryBlocks$procedures_Msg.PROCEDURES_DEFNORETURN_TITLE).appendField(
          a,
          "NAME"
        ).appendField("", "PARAMS");
      ...
      module$exports$Blockly$libraryBlocks$procedures.blocks.procedures_defreturn = Object.assign({}, module$contents$Blockly$libraryBlocks$procedures_PROCEDURE_DEF_COMMON, { init: function() {
        var a = $.module$build$src$core$procedures.findLegalName("", this);
        a = $.module$build$src$core$field_registry.fromJson({ type: "field_input", text: a });
        a.setValidator($.module$build$src$core$procedures.rename);
        a.setSpellcheck(false);
        this.appendDummyInput().appendField(module$contents$Blockly$libraryBlocks$procedures_Msg.PROCEDURES_DEFRETURN_TITLE).appendField(
          a,
          "NAME"
        ).appendField("", "PARAMS");
      ...
      module$exports$Blockly$libraryBlocks$procedures.blocks.procedures_mutatorcontainer = { init: function() {
        this.appendDummyInput().appendField(module$contents$Blockly$libraryBlocks$procedures_Msg.PROCEDURES_MUTATORCONTAINER_TITLE);
        this.appendStatementInput("STACK");
        this.appendDummyInput("STATEMENT_INPUT").appendField(module$contents$Blockly$libraryBlocks$procedures_Msg.PROCEDURES_ALLOW_STATEMENTS).appendField($.module$build$src$core$field_registry.fromJson({ type: "field_checkbox", checked: true }), "STATEMENTS");
        this.setStyle("procedure_blocks");
        this.setTooltip(module$contents$Blockly$libraryBlocks$procedures_Msg.PROCEDURES_MUTATORCONTAINER_TOOLTIP);
        this.contextMenu = false;
      } };
      module$exports$Blockly$libraryBlocks$procedures.blocks.procedures_mutatorarg = { init: function() {
        const a = $.module$build$src$core$field_registry.fromJson({ type: "field_input", text: $.module$build$src$core$procedures.DEFAULT_ARG });
      ...
      var module$contents$Blockly$libraryBlocks$procedures_PROCEDURE_CALL_COMMON = { getProcedureCall: function() {
        ...
        var c = $.module$build$src$core$procedures.getDefinition(this.getProcedureCall(), this.workspace), d = c && c.mutator && c.mutator.isVisible();
        d ? this.setCollapsed(false) : (this.quarkConnections_ = {}, this.quarkIds_ = null);
        ...
        if (this.workspace && !this.workspace.isFlyout && a.recordUndo) if (a.type === $.module$build$src$core$events$events.BLOCK_CREATE && -1 !== a.ids.indexOf(this.id)) {
          ...
          if (!b) {
            ...
            var c = this.getRelativeToSurfaceXY(), d = c.y + 2 * $.config$$module$build$src$core$config.snapRadius;
      ...
      module$exports$Blockly$libraryBlocks$procedures.blocks.procedures_callnoreturn = Object.assign({}, module$contents$Blockly$libraryBlocks$procedures_PROCEDURE_CALL_COMMON, { init: function() {
      ...
      module$exports$Blockly$libraryBlocks$procedures.blocks.procedures_callreturn = Object.assign({}, module$contents$Blockly$libraryBlocks$procedures_PROCEDURE_CALL_COMMON, { init: function() {
        this.appendDummyInput("TOPROW").appendField("", "NAME");
        this.setOutput(true);
        this.setStyle("procedure_blocks");
      ...
      module$exports$Blockly$libraryBlocks$procedures.blocks.procedures_ifreturn = {
        ...
        onchange: function(a) {
          if (!(this.workspace.isDragging && this.workspace.isDragging() || a.type !== $.module$build$src$core$events$events.BLOCK_MOVE)) {
            ...
            b ? ("procedures_defnoreturn" === c.type && this.hasReturnValue_ ? (this.removeInput("VALUE"), this.appendDummyInput("VALUE").appendField(module$contents$Blockly$libraryBlocks$procedures_Msg.PROCEDURES_DEFRETURN_RETURN), this.hasReturnValue_ = false) : "procedures_defreturn" !== c.type || this.hasReturnValue_ || (this.removeInput("VALUE"), this.appendValueInput("VALUE").appendField(module$contents$Blockly$libraryBlocks$procedures_Msg.PROCEDURES_DEFRETURN_RETURN), this.hasReturnValue_ = true), this.setWarningText(null)) : this.setWarningText(module$contents$Blockly$libraryBlocks$procedures_Msg.PROCEDURES_IFRETURN_WARNING);
      ...
      ], style: "text_blocks", tooltip: "%{BKY_TEXT_CREATE_JOIN_TOOLTIP}", enableContextMenu: false }, { type: "text_create_join_item", message0: "%{BKY_TEXT_CREATE_JOIN_ITEM_TITLE_ITEM}", previousStatement: null, nextStatement: null, style: "text_blocks", tooltip: "%{BKY_TEXT_CREATE_JOIN_ITEM_TOOLTIP}", enableContextMenu: false }, {
        type: "text_append",
      ...
      module$exports$Blockly$libraryBlocks$texts.blocks.text_getSubstring = { init: function() {
        ...
        this.WHERE_OPTIONS_2 = [
          [module$contents$Blockly$libraryBlocks$texts_Msg.TEXT_GET_SUBSTRING_END_FROM_START, "FROM_START"],
          [module$contents$Blockly$libraryBlocks$texts_Msg.TEXT_GET_SUBSTRING_END_FROM_END, "FROM_END"],
          [module$contents$Blockly$libraryBlocks$texts_Msg.TEXT_GET_SUBSTRING_END_LAST, "LAST"]
        ];
        ...
        2 === a && module$contents$Blockly$libraryBlocks$texts_Msg.TEXT_GET_SUBSTRING_TAIL && (this.removeInput("TAIL", true), this.appendDummyInput("TAIL").appendField(module$contents$Blockly$libraryBlocks$texts_Msg.TEXT_GET_SUBSTRING_TAIL));
        const c = $.module$build$src$core$field_registry.fromJson({ type: "field_dropdown", options: this["WHERE_OPTIONS_" + a] });
        c.setValidator(function(d) {
          const e = "FROM_START" === d || "FROM_END" === d;
          if (e !== b) {
      ...
      module$exports$Blockly$libraryBlocks$texts.blocks.text_changeCase = { init: function() {
        ...
        this.setStyle("text_blocks");
        this.appendValueInput("TEXT").setCheck("String").appendField($.module$build$src$core$field_registry.fromJson({ type: "field_dropdown", options: a }), "CASE");
        this.setOutput(true, "String");
        this.setTooltip(module$contents$Blockly$libraryBlocks$texts_Msg.TEXT_CHANGECASE_TOOLTIP);
      } };
      module$exports$Blockly$libraryBlocks$texts.blocks.text_trim = { init: function() {
      ...
      module$exports$Blockly$libraryBlocks$texts.blocks.text_prompt_ext = Object.assign({}, module$contents$Blockly$libraryBlocks$texts_TEXT_PROMPT_COMMON, { init: function() {
      ...
      module$exports$Blockly$libraryBlocks$texts.blocks.text_prompt = Object.assign({}, module$contents$Blockly$libraryBlocks$texts_TEXT_PROMPT_COMMON, { init: function() {
        ...
        this.appendDummyInput().appendField(a, "TYPE").appendField(this.newQuote_(true)).appendField($.module$build$src$core$field_registry.fromJson({ type: "field_input", text: "" }), "TEXT").appendField(this.newQuote_(false));
        this.setOutput(true, "String");
        this.setTooltip(function() {
          return "TEXT" === b.getFieldValue("TYPE") ? module$contents$Blockly$libraryBlocks$texts_Msg.TEXT_PROMPT_TOOLTIP_TEXT : module$contents$Blockly$libraryBlocks$texts_Msg.TEXT_PROMPT_TOOLTIP_NUMBER;
        });
      } });
      module$exports$Blockly$libraryBlocks$texts.blocks.text_count = { init: function() {
        this.jsonInit({ message0: module$contents$Blockly$libraryBlocks$texts_Msg.TEXT_COUNT_MESSAGE0, args0: [{ type: "input_value", name: "SUB", check: "String" }, { type: "input_value", name: "TEXT", check: "String" }], output: "Number", inputsInline: true, style: "text_blocks", tooltip: module$contents$Blockly$libraryBlocks$texts_Msg.TEXT_COUNT_TOOLTIP, helpUrl: module$contents$Blockly$libraryBlocks$texts_Msg.TEXT_COUNT_HELPURL });
      } };
      module$exports$Blockly$libraryBlocks$texts.blocks.text_replace = { init: function() {
        this.jsonInit({ message0: module$contents$Blockly$libraryBlocks$texts_Msg.TEXT_REPLACE_MESSAGE0, args0: [{ type: "input_value", name: "FROM", check: "String" }, { type: "input_value", name: "TO", check: "String" }, { type: "input_value", name: "TEXT", check: "String" }], output: "String", inputsInline: true, style: "text_blocks", tooltip: module$contents$Blockly$libraryBlocks$texts_Msg.TEXT_REPLACE_TOOLTIP, helpUrl: module$contents$Blockly$libraryBlocks$texts_Msg.TEXT_REPLACE_HELPURL });
      } };
      module$exports$Blockly$libraryBlocks$texts.blocks.text_reverse = { init: function() {
        this.jsonInit({ message0: module$contents$Blockly$libraryBlocks$texts_Msg.TEXT_REVERSE_MESSAGE0, args0: [{ type: "input_value", name: "TEXT", check: "String" }], output: "String", inputsInline: true, style: "text_blocks", tooltip: module$contents$Blockly$libraryBlocks$texts_Msg.TEXT_REVERSE_TOOLTIP, helpUrl: module$contents$Blockly$libraryBlocks$texts_Msg.TEXT_REVERSE_HELPURL });
      } };
      ...
      }, module$contents$Blockly$libraryBlocks$texts_TEXT_JOIN_MUTATOR_MIXIN = { mutationToDom: function() {
        const a = $.module$build$src$core$utils$xml.createElement("mutation");
        a.setAttribute("items", this.itemCount_);
        return a;
      }, domToMutation: function(a) {
      ...
      var module$contents$Blockly$libraryBlocks$texts_TEXT_INDEXOF_TOOLTIP_EXTENSION = function() {
      ...
      }, module$contents$Blockly$libraryBlocks$texts_TEXT_CHARAT_MUTATOR_MIXIN = { mutationToDom: function() {
        const a = $.module$build$src$core$utils$xml.createElement("mutation");
        ...
        module$contents$Blockly$libraryBlocks$texts_Msg.TEXT_CHARAT_TAIL && (this.removeInput("TAIL", true), this.appendDummyInput("TAIL").appendField(module$contents$Blockly$libraryBlocks$texts_Msg.TEXT_CHARAT_TAIL));
        this.isAt_ = a;
      ...
      var module$contents$Blockly$libraryBlocks$variables_CUSTOM_CONTEXT_MENU_VARIABLE_GETTER_SETTER_MIXIN = { customContextMenu: function(a) {
        if (!this.isInFlyout) {
          ...
          a.push(d);
        } else if ("variables_get" === this.type || "variables_get_reporter" === this.type) b = { text: module$contents$Blockly$libraryBlocks$variables_Msg.RENAME_VARIABLE, enabled: true, callback: module$contents$Blockly$libraryBlocks$variables_renameOptionCallbackFactory(this) }, d = this.getField("VAR").getText(), d = { text: module$contents$Blockly$libraryBlocks$variables_Msg.DELETE_VARIABLE.replace("%1", d), enabled: true, callback: module$contents$Blockly$libraryBlocks$variables_deleteOptionCallbackFactory(this) }, a.unshift(b), a.unshift(d);
      ...
      var module$contents$Blockly$libraryBlocks$variablesDynamic_CUSTOM_CONTEXT_MENU_VARIABLE_GETTER_SETTER_MIXIN = { customContextMenu: function(a) {
        if (!this.isInFlyout) {
      ...
      var module$exports$Blockly$libraryBlocks = { colour: module$build$src$blocks$colour, math: module$build$src$blocks$math }, module$contents$Blockly$libraryBlocks_BlockDefinition = Object;
...
var require_blocks = __commonJS({
  "node_modules/blockly/blocks.js"(exports, module) {
    (function(root, factory) {
      if (typeof define === "function" && define.amd) {
        define(["./blocks_compressed"], factory);
      } else if (typeof exports === "object") {
        module.exports = factory(require_blocks_compressed());
      } else {
        root.BlocklyBlocks = factory(root.BlocklyBlocks);
      }
    })(exports, function(BlocklyBlocks) {
...
var require_browser = __commonJS({
  "node_modules/blockly/browser.js"(exports, module) {
    (function(root, factory) {
      if (typeof define === "function" && define.amd) {
        define(["./core-browser", "./msg/en", "./blocks", "./javascript"], factory);
      } else if (typeof exports === "object") {
        module.exports = factory(require_core_browser(), require_en(), require_blocks(), require_javascript());
      } else {
        root.Blockly = factory(root.Blockly, root.En, root.BlocklyBlocks, root.BlocklyJS);
      }
    })(exports, function(Blockly, En, BlocklyBlocks, BlocklyJS) {
      "use strict";
  ...
  "node_modules/blockly/index.js"(exports, module) {
    (function(root, factory) {
      if (typeof define === "function" && define.amd) {
        ...
        module.exports = factory(require_browser());
      } else {
        root.Blockly = factory(root.Blockly);
      }
    })(exports, function(Blockly) {
      return Blockly;
    });
  }
});
export default require_blockly();
